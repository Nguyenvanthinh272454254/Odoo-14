...
class ResCompany(models.Model):
    ...
    show_name_report = fields.Boolean('Show Report name revision', default='False')
    name_report_picking = fields.Char('Name', default='PICKING-RP')
    date_report_picking = fields.Char('Date issued', default='31-12-2018')
    rev_report_picking = fields.Char('Revision', default='1.0')
    name_report_delivery = fields.Char('Name', default='DELIVERY-RP')
    date_report_delivery = fields.Char('Date issued', default='31-12-2018')
    rev_report_delivery = fields.Char('Revision', default='1.0')
    name_report_pur = fields.Char('Name', default='PUR-RP')
    date_report_pur = fields.Char('Date issued', default='31-12-2018')
    rev_report_pur = fields.Char('Revision', default='1.0')
    name_report_sale = fields.Char('Name', default='SALE-RP')
    date_report_sale = fields.Char('Date issued', default='31-12-2018')
    rev_report_sale = fields.Char('Revision', default='1.0')
    name_report_prd = fields.Char('Name', default='PRD-RP')
    date_report_prd = fields.Char('Date issued', default='31-12-2018')
    rev_report_prd = fields.Char('Revision', default='1.0')
    name_report_inv = fields.Char('Name', default='INVOICE-RP')
    date_report_inv = fields.Char('Date issued', default='31-12-2018')
    rev_report_inv = fields.Char('Revision', default='1.0')
    name_report_adj = fields.Char('Name', default='ADJUSTMENTS-RP')
    date_report_adj = fields.Char('Date issued', default='31-12-2018')
    rev_report_adj = fields.Char('Revision', default='1.0')
